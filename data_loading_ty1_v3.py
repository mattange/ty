...
orig_data.to_pickle(SHEET + '_orig_data.dat')
...
sabr_data = sabr_data.reindex(orig_data.index)
sabr_data.to_pickle(SHEET + '_sabr_data.dat')
sabr_data.to_excel(writer, sheet_name=SHEET + '_sabr_data', na_rep='na')

#################################################################################
# Store detail price data.
#################################################################################
price_detail = price_detail.reindex(orig_data.index)
price_detail.to_pickle(SHEET + '_price_detail.dat')
